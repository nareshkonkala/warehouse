...
<title>WH-User Registration Page</title>
<link rel="stylesheet"
...
<body>
	<div class="container">
		<div class="row">
			<div class="col-2"></div>
			<div class="col-6">
				<div class="h3 text-success ">Welcome to the WH-User Registration Page</div>
			</div>
		</div>
		<br>
		<form:form action="save" method="POST" modelAttribute="whUserType">
			<div class="row">
				<div class="col-2"></div>
				<div class="col-2">
					<form:label path="whType">User Type : </form:label>
				</div>
				<div class="col-2">
					<form:radiobutton path="whType" value="Vendor"  />Vendor
				</div>
				<div class="col-2">
					<form:radiobutton path="whType" value="Customer"  />Customer
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-4">
					<form:input path="whCode" class="form-control" />
				</div>
			</div>
			<br>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-4">
					<form:input path="whEmail" class="form-control" />
				</div>
			</div>
			<br>
			<div class="row">
				...
				<div class="col-4">
					<form:input path="whcontact" class="form-control" />
				</div>
			</div>
			<br>	
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-4">
					<form:input path="whIdNum" class="form-control" />
				</div>
			</div>
			<br>
			<div class="row">
