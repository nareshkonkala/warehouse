			...
			<div class="card-body ">
				<table class="table table-border table-hover">
					...
					<c:forEach items="${list}" var="obj">
						<tr>
							<td><c:out value="${obj.stId}" /></td>
							<td><c:out value="${obj.stMode}" /></td>
							<td><c:out value="${obj.stCode}" /></td>
							<td><c:out value="${obj.stGrade}" /></td>
							<th><a href="delete?id=${obj.stId}" class=""><img src="../resources/images/delete.png" height="50" width="60"></a></th>
							<th><a href="edit?id=${obj.stId}" class=""><img src="../resources/images/edit.png" height="50" width="50"></a></th>
							<td><a href="view?id=${obj.stId}" class=""> <img src="../resources/images/search.png" height="50" width="50"></a></td>
