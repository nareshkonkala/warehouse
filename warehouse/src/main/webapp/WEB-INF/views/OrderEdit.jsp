	...
	<div class="container">
		...
		<form:form action="update" method="POST" modelAttribute="order">
			<div class="row">
				<div class="col-2"></div>
				<div class="col-2">
					<form:label path="orderId">ID : </form:label>
				</div>
				<div class="col-4">
					<form:input path="orderId" class="form-control" value="${order.orderId}" readonly="true" />
				</div>
			</div>
			<br>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-4">
					<form:input path="orderCode" class="form-control" value="${order.orderCode}" readonly="true"/>
				</div>
			</div>
			<br>
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-4">
					<form:checkbox path="orderAccept" class="form-control" value="Multi Model" /><span>Multi Model</span>
					<form:checkbox path="orderAccept" class="form-control" value="Accept Return" />Accept Return
					<form:checkbox path="orderAccept" class="form-control" value="Service Exted" />Service Exted
				</div>
			</div>
			<br>
			...
			<div class="row">
				...
				<div class="col-4">
					<form:textarea path="note" class="form-control" value="${order.note}" name="note" />
				</div>
			</div>
			<br>
			<div class="row">
